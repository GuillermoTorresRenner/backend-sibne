...
CREATE TABLE "dbo"."UsuarioLogin" (
    ...
    CONSTRAINT "UsuarioLogin_pkey" PRIMARY KEY ("loginProvider","providerKey")
);
...
CREATE TABLE "dbo"."UsuarioToken" (
    ...
    CONSTRAINT "UsuarioToken_pkey" PRIMARY KEY ("userId","loginProvider","name")
);
...
-- AddForeignKey
ALTER TABLE "dbo"."UsuarioLogin" ADD CONSTRAINT "UsuarioLogin_userId_fkey" FOREIGN KEY ("userId") REFERENCES "dbo"."Usuario"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dbo"."UsuarioRole" ADD CONSTRAINT "UsuarioRole_UserId_fkey" FOREIGN KEY ("UserId") REFERENCES "dbo"."Usuario"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dbo"."UsuarioRole" ADD CONSTRAINT "UsuarioRole_RoleId_fkey" FOREIGN KEY ("RoleId") REFERENCES "dbo"."Role"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dbo"."UsuarioToken" ADD CONSTRAINT "UsuarioToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "dbo"."Usuario"("id") ON DELETE CASCADE ON UPDATE CASCADE;
